            ...
            Price: {
                options: {
                    ...
                    grid: {
                        ...
                        style: {
                            fontSize: '14px', fontWeight: 'bold', color: "#2962A5"
                        }
                    }, stroke: {
                        curve: 'smooth'
                    }, xaxis: {
            ...
            ,Market_Cap: {
                options: {
                    ...
                    grid: {
                        ...
                        text: "Market Cap (INR)",
                        style: {
                            fontSize: '14px', fontWeight: 'bold', color: '#1A4B8E', 
                        }
                    }, stroke: {
                        curve: 'smooth'
                    }, xaxis: {
                    ...
                    <div className="row">
                        ...
                        <div className="col" style={{ maxWidth: '200px' }}>
                            ...
                            <div className="card-body ">
                                <h6 className="card-title" style={{  }}> Total Supply </h6>
                                <p className="card-text fw-bold "
                                    style={{  color: '#649ECE', fontSize: 'small' }}>
                                    {this.props.total_supply}
                                </p>
                            </div>


                            {/* <div className="card-body ">
                                <h6 className="card-title" style={{  }}>Offical Website</h6>
                                <p className="card-text fw-bold "
                                style={{  color: '#649ECE' ,fontSize: 'small' }}>
                                <a href={this.props.home} target="_blank" rel="noreferrer">HomePage</a>
                                </p>
                            </div> */}

                            <div className="card-body ">
                                <h6 className="card-title" style={{  }}> Price Change </h6>
                                <p className="card-text fw-bold "
                                    style={{  color: '#649ECE', fontSize: 'small' }}>
                                    {this.props.priceChange24} % in 24hrs
                                </p>
                            </div>

                            <div className="card-body ">
                                <h6 className="card-title" style={{  }}> Market Cap Change </h6>
                                <p className="card-text fw-bold "
                                    style={{  color: '#649ECE', fontSize: 'small' }}>
                                    {this.props.marketCap24} % in 24hrs
                                </p>
                            </div>

                            {/* <div className="card-body ">
                                <h6 className="card-title" style={{  }}> Total Volume </h6>
                                <p className="card-text fw-bold "
                                    style={{  color: '#649ECE', fontSize: 'small' }}>
                                    ₹ {this.props.TotVol}
                                </p>
                            ...
                            <div className="card-body ">
                                <h6 className="card-title" style={{  }}> Circulating Supply</h6>
                                <p className="card-text fw-bold "
                                    style={{  color: '#649ECE', fontSize: 'small' }}>
                            ...
                            <div className="card-body ">
                                <h6 className="card-title" style={{  }}> Last Update </h6>
                                <p className="card-text fw-bold "
                                    style={{  color: '#649ECE', fontSize: 'small' }}>
                                    {this.props.LastUp}
                                </p>
                            ...
                            {/* <div className="card-body ">
                                <h6 className="card-title" style={{  }}> Image </h6>
                                <p className="card-text fw-bold "
                                    style={{  color: '#649ECE', fontSize: 'small' }}>
                                    {this.props.img}
                                </p>
